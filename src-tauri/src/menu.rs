...
pub fn build_menu<R: Runtime>(app: &AppHandle<R>) -> tauri::Result<Menu<R>> {
    ...
    // Edit menu — REQUIRED on macOS for ⌘C/⌘V/⌘X/⌘A to work in text inputs.
    // Without these items bound to those accelerators, NSResponder doesn't route
    // the keystrokes to the focused field, and paste silently no-ops.
