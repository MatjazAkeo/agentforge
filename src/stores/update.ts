...
/** Pre-release identifiers we treat as "beta" — only -alpha and -beta in
 *  the SemVer pre-release segment. Stable versions (no pre-release segment)
 *  always pass through. */
const BETA_RE = /-(?:beta|alpha)(?:[.\d-].*)?$/i;
